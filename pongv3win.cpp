...
void PrintScr(){
    system("cls");
    printf(borders);
    printf(screen,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20);
    printf(borders);
}
...
void CreateGame(){
    ...
    border[settings->layoutx-1]=0xc5;
...
bool Action(){
    ...
    if(b->cur>b->head+15||b->cur==b->head){
        b->vy=-b->vy;
    }
    return dv;
}
